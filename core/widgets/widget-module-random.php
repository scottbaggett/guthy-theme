...
class Milkit_Widget_Module_Random extends WP_Widget {

	public function __construct() {
		$widget_ops = array(
			'classname' => 'milkit_widget_module_random',
			'description' => __( 'Your site\'s Posts in random order.', 'milkit' )
		);
		parent::__construct( 'milkit_widget_module_random', __( 'Milkit Post Modules - Random', 'milkit' ), $widget_ops );
		$this->alt_option_name = 'milkit_widget_module_random';
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions[ 'milkit_widget_module_random' ] ) ) {
			delete_option( 'milkit_widget_module_random' );
		}
	...
	public function flush_widget_cache() {
		wp_cache_delete( 'milkit_widget_module_random', 'widget' );
	}
...
add_action( 'widgets_init', 'milkit_widget_module_random' );

function milkit_widget_module_random() {
	register_widget( 'Milkit_Widget_Module_Random' );
}
