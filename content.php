...
<?php
$milkit_post_module_cols = ( get_option( 'milkit_opt_blog_post_columns' ) ) ? get_option( 'milkit_opt_blog_post_columns' ) : 'post-module-1cols';
...
<article <?php post_class( $milkit_post_module_classes ); ?> itemscope="itemscope" itemtype="http://schema.org/Article">
	...
	<?php if ( ! ( get_option( 'milkit_opt_blog_post_thumbnail' ) == 'false' ) ) {

		$milkit_post_thumb_size = 'milkit_1330x590';

		/* layout without sidebar */
		if ( get_option( 'milkit_opt_blog_layout' ) == 'no-sidebar' ) {
	...
	<div class="post-module-content">
		...
		<header class="entry-header">
			...
			<?php if ( ! ( get_option( 'milkit_opt_blog_post_cat_icon' ) == 'false' ) ) {
				milkit_entry_cats();
			} ?>
		...
		<?php if ( get_option( 'milkit_opt_blog_post_excerpt' ) == 'true' ) : ?>
		...
		<footer class="entry-footer">
			...
			<div class="author-date">
				<?php
				$milkit_date_vis_var = ( get_option( 'milkit_opt_blog_post_date' ) == 'false' ) ? true : false;
				$milkit_author_vis_var = ( get_option( 'milkit_opt_blog_post_author' ) == 'false' ) ? true : false;
			...
			<?php if ( ! ( get_option( 'milkit_opt_blog_post_review_icon' ) == 'false' ) ) {
